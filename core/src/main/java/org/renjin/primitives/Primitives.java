...
import org.renjin.primitives.s4.S4;
...
public class Primitives {
  ...
  public Primitives() {
    ...
    f("as.function.default", Types.class, 11, PREC_FN, 0);
    ...
    f("[",Subsetting.class, 0, PREC_SUBSET, 0);
    f("[[", Subsetting.class, 0, PREC_SUBSET, 0);
    f("$", Subsetting.class, 0, PREC_DOLLAR, 0);
    f("@", Subsetting.class, 0, PREC_DOLLAR, 0);
    f("[<-", Subsetting.class, 0, PREC_LEFT, 1);
    f("[[<-", Subsetting.class, 0, PREC_LEFT, 1);
    f("$<-", Subsetting.class, 0, PREC_LEFT, 1);
    ...
    f("identical",  Types.class, 11);


/* Binary Operators */
/* these are group generic and so need to eval args */
    f("+",  Ops.class,  /* PLUSOP, */ 1, PREC_SUM, 0);
    f("-", Ops.class,   /* MINUSOP, */ 1, PREC_SUM, 0);
    f("*", Ops.class,  /*TIMESOP ,*/ 1, PREC_PROD, 0);
    f("/", Ops.class,  /*DIVOP,*/ 1, PREC_PROD, 0);
    f("^", Ops.class,   /*POWOP,*/ 1, PREC_POWER, 1);
//    add(new OpsFunction("+"));
//    add(new OpsFunction("-"));
//    add(new OpsFunction("*"));
//    add(new OpsFunction("/"));
//    add(new OpsFunction("^"));
    ...
    f("%%", Ops.class,  /* MODOP */ 1, PREC_PERCENT, 0);
    f("%/%", Ops.class,  /* IDIVOP */ 1, PREC_PERCENT, 0);
    f("%*%", Matrices.class, 1, PREC_PERCENT, 0);
    f("crossprod", Matrices.class, 11);
    f("tcrossprod", Matrices.class, 11);


/* these are group generic and so need to eval args */
    f("==", Ops.class, 1, PREC_COMPARE, 0);
    f("!=", Ops.class, 1, PREC_COMPARE, 0);
    f("<", Ops.class, 1, PREC_COMPARE, 0);
    f("<=", Ops.class, 1, PREC_COMPARE, 0);
    f(">=", Ops.class, 1, PREC_COMPARE, 0);
    f(">", Ops.class, 1, PREC_COMPARE, 0);
    f("&", Ops.class, 1, PREC_AND, 0);
    f("|", Ops.class, 1, PREC_OR, 0);
    f("!", Ops.class, 1, PREC_NOT, 0);
//    add(new OpsFunction("=="));
//    add(new OpsFunction("!="));
//    add(new OpsFunction("<"));
//    add(new OpsFunction("<="));
...
//    add(new OpsFunction("!"));
    ...
    f("&&", Comparison.class, "and", 1, PREC_AND, 0);
    f("||", Comparison.class, "or", 2, PREC_OR, 0);
    f(":", Sequences.class, "colon", 0, PREC_COLON, 0);
 ...
 * ---------  -------   ------  ----  ----- -------      ---------- ----------*/
    f("vector", Types.class, 11);
    f("complex", ComplexGroup.class, 11);
    f("matrix", Matrices.class, 11);
    f("length", Types.class, 1);
    f("length<-", Types.class, 1, PREC_LEFT, 1);
    ...
    f("drop", Types.class, 11);
    f("oldClass", Attributes.class, 1);
    f("oldClass<-", Attributes.class, 1, PREC_LEFT, 1);
    f("class", Attributes.class, "getClass", 1);
    f(".cache_class", Methods.class, 1, PREC_FN, 0);
    f("class<-", Attributes.class, "setClass", 1);
    f("unclass", Attributes.class, 1);
    f("names", Attributes.class,  "getNames", 1);
    f("names<-", Attributes.class, "setNames", 0, PREC_LEFT, 1);
    f("dimnames", Attributes.class, 1);
    f("dimnames<-", Attributes.class, 1, PREC_LEFT, 1);
    f("all.names", AllNamesVisitor.class, 11);
    f("dim", Attributes.class, 1);
    f("dim<-", Attributes.class, 1, PREC_LEFT, 1);
    f("attributes", Attributes.class, 1);
    f("attributes<-", Attributes.class, null, 0, PREC_LEFT, 1);
    f("attr", Attributes.class, 1);
    f("attr<-", Attributes.class, 1, PREC_LEFT, 1);
    f("comment", Attributes.class, 11);
    f("comment<-", Attributes.class, 11, PREC_LEFT, 1);
    f("levels<-", Attributes.class, 1, PREC_LEFT, 1);
    f("get", Types.class, 11);
    f("mget", /*mget*/ null, 11);
    f("exists", Types.class, 11);
    ...
    f("attach", Types.class, 111);
    f("detach", Types.class, 111);
    f("search", Types.class, 11);
...
/* Note that the number of arguments for the primitives in the Math group
   only applies to the default method. */
    ...
    f("lgamma", org.apache.commons.math.special.Gamma.class, "logGamma", 1);
...
/* Mathematical Functions of Two Numeric (+ 1-2 int) Variables */
    ...
    f("qpois", Distributions.class, 11);
...
/* Type coercion */
    ...
    f("as.character", Types.class, "asCharacter", 1);
    f("as.integer", Types.class, "asInteger", 1);
    f("as.double", Types.class, "asDouble", 1);
    f("as.complex", Types.class, 1);
    f("as.logical", Types.class, "asLogical", 1);
    f("as.raw", Types.class, 1);
    f("as.vector", Types.class, 11);
    f("paste", Text.class, 11);
    f("file.path", Text.class, 11);
    f("format", Text.class, 11);
    f("format.info", /*formatinfo*/ null, 11);
    f("cat", Cat.class, 111);
    f("call", Evaluation.class, 0);
    f("do.call", Evaluation.class, 211);
    f("as.call", Types.class, 1);
    f("type.convert", Scan.class, 11);
    f("as.environment", Types.class, "asEnvironment", 1);
    f("storage.mode<-", Types.class, 1);
...
/* String Manipulation */
    ...
    f("charToRaw", Types.class, 11);
    f("rawToChar", Types.class, 11);
    f("rawShift", Types.class , 11);
    f("intToBits", Types.class, 11);
    f("rawToBits", Types.class , 11);
...
/* Miscellaneous */
    ...
    f("rep", Sequences.class, 0);
    f("rep.int", Sequences.class, 11);
    f("seq.int", Sequences.class, 0);
    f("seq_len", Sequences.class, 1);
    f("seq_along", Sequences.class, "seqAlong", 1);
    f("list", Types.class, "list", 1);
    f("split",  Split.class, 11);
    f("is.loaded", /*isloaded*/ null, 11, PREC_FN, 0);
    f(".C", Native.class, 1, PREC_FN, 0);
    f(".Fortran", Native.class, 1, PREC_FN, 0);
    f(".External", /*External*/ null, 1, PREC_FN, 0);
    f(".Call", Native.class, 1, PREC_FN, 0);
    f(".External.graphics", /*Externalgr*/ null, 1, PREC_FN, 0);
    f(".Call.graphics", /*dotcallgr*/ null, 1, PREC_FN, 0);
    f("recordGraphics", /*recordGraphics*/ null, 211, PREC_FN, 0);
    f("dyn.load", Native.class, 111);
    f("dyn.unload", System.class, 111);
    f("ls", Types.class, 11);
    f("typeof", Types.class, 11);
    f("eval", Evaluation.class, 211);
    f("eval.with.vis",Evaluation.class, 211);
    f("withVisible", /*withVisible*/ null, 10);
    f("expression", Types.class, 0);
    ...
    f("emptyenv", Types.class, 1);
    f("baseenv", Types.class, 1);
    f("globalenv", Types.class, 1);
    f("environment", Types.class, 11);
    f("environment<-", Types.class, 1, PREC_LEFT, 1);
    f("environmentName", Types.class, 11);
    f("env2list", Types.class, 11);
    ...
    f("merge", /*merge*/ null, 11);
    f("capabilities", System.class, 11);
    f("capabilitiesX11", /*capabilitiesX11*/ null, 11);
    f("new.env", Types.class, 11);
    f("parent.env", Types.class, 11);
    f("parent.env<-", Types.class, 11, PREC_LEFT, 1);
...
/* Graphics */
    ...
    f("box", Plot.class, 111);
    f("rect", Plot.class, 111);
    f("polygon", Plot.class, 111);
    f("xspline", Plot.class, 111);
    f("par", Par.class, 11);
...
/* date-time manipulations */
    ...
    f("Date2POSIXlt", /*D2POSIXlt*/ null, 11);
    f("POSIXlt2Date", /*POSIXlt2D*/ null, 11);
...
/* Connections */
    ...
    f("clearPushBack", Connections.class, 11);
    ...
    f("lockEnvironment", Types.class, 111);
    f("environmentIsLocked", Types.class, 11);
    f("lockBinding", Types.class, 111);
    f("unlockBinding", Types.class, 111);
    f("bindingIsLocked", Types.class, 11);
...
/* looks like mkUnbound is unused in base R */
  ...
  // REMOVED: f("lazyLoadDBfetch", Serialization.class, 0, 1, 4);
    ...
    f("icuSetCollate", /*ICUset*/ null, 111, PREC_FN, 0) ;
    ...
    f("setClass", S4.class, 0);
    f("setMethod", S4.class, 0);
    f("representation", S4.class, 0);
    f("new", S4.class, 0);
  ...
  private void f(String name, Class cfun, int eval, PPprec prec, int rightassoc) {
    Entry e = new Entry(name, cfun, name, eval, new PPinfo(prec, rightassoc));
    add(e);
  }

  private void f(String name, Class cfun, String methodName, int eval, PPprec prec, int rightassoc) {
    Entry e = new Entry(name, cfun,methodName, eval, new PPinfo(prec, rightassoc));
    add(e);
  }
  ...
  private void f(String name, Class clazz, int eval) {
    ...
    e.eval = eval;
    e.gram = new PPinfo(PPprec.PREC_RIGHT, 0);
    add(e);
  }
  ...
  public static class PPinfo {
    ...
    private PPinfo(PPprec precedence, int rightassoc) {
  ...
  public static class Entry {
    ...
    private Entry(String name, Class functionClass, String methodName, int eval, PPinfo gram) {
      this.name = name;
