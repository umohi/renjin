...
import org.renjin.invoke.InvokerFactory;
...
public final class ExternalPtr<T> extends AbstractSEXP {
  ...
  public ExternalPtr(T instance, AttributeMap attributes) {
    super(attributes);
    if(instance == null) {
      throw new IllegalArgumentException("instance value of ExternalPtr cannot be null");
    }
    this.instance = instance;
    if(instance instanceof Class) {
      this.binding = InvokerFactory.getClassDefinitionBinding((Class) instance);
    } else {
      this.binding = InvokerFactory.getClassBinding(instance.getClass());
    }
  }
