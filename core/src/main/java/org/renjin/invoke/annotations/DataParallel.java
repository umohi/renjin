...
/**
 * Indicates that this Java method is a Single Instruction Multiple Data (SIMD)
 * primitive that should be applied to all elements of an R vector. The Java method
