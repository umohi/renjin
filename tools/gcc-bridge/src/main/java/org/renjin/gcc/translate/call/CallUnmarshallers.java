...
public class CallUnmarshallers {
  ...
  public void unmarshall(FunctionContext context, GimpleLValue lhs, JimpleType returnType, JimpleExpr callExpr) {
    ...
    if (lhs == null) {
      ...
      throw new UnsupportedOperationException(String.format(
          "Don't know how to unmarshall call result from [%s] => [%s]", returnType.toString(), lhs.toString()));
    }
  }
